...
<div class="dashboard-wrapper">
    <div class="container-fluid  dashboard-content">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title">Sửa thông tin nhà cung cấp</h2>

                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                  <a href="#" class="breadcrumb-link">Bảng điều khiển</a></li>
                                <li class="breadcrumb-item">
                                  <a href="#" class="breadcrumb-link">Các bảng quản lý</a></li>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">Sửa thông tin nhà cung cấp</h5>
                    <div class="card-body">
                        <form modelAttribute="nhacc" data-parsley-validate=""
                              novalidate="" method="POST" action="/admin/edit-supplier">

                            <input type="hidden" name="id" value="${nhacc.id}"/>
                            <div class="form-group row">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Tên
                                    nhà cung cấp:</label>
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input name="name" type="text" required="" placeholder=""
                                           class="form-control" value="${nhacc.name}"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Đia chỉ</label>
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input name="address" type="text" required="" placeholder=""
                                           class="form-control" value="${nhacc.address}"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input name="mobile" type="text" required="" placeholder=""
                                           class="form-control" value="${nhacc.mobile}"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-6">
                                    <input name="email" type="text" required="" placeholder=""
                                           class="form-control" value="${nhacc.email}"/>
                                </div>
                            </div>
                            <div class="form-group row">
